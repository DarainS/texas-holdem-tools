...
Kxs = ['KQs', 'KJs', 'KTs', 'K9s', 'K8s', 'K7s', 'K6s', 'K5s', 'K4s', 'K3s', 'K2s''KQs', 'KJs', 'KTs', 'K9s', 'K8s',
...
allHandsType = [pair, Axs, Axo, Kxs, Kxo, sc1, sc2, oc1, oc2, Qxs, Qxo, Jxs, Jxo, Txs, Txo, x9s, x9s, x8s, x8o, x7s,
                x7o, x6s, x6o, x5s, x5o, x4s, x4o, x3s, x3o, ]
